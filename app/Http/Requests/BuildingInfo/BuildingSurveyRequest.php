...
class BuildingSurveyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "owner_gender" => "required|in:Male,Female,Others",
            ...
            "use_category_id" => "nullable|integer",
            ...
            "payload_json.structure_type_id" => "required",
            ...
            "payload_json.watersupply_pipe_code" => "required_if:water_source_id,5|nullable|string|max:255",
    ...
    public function messages()
    {
        return [
            ...
            "owner_gender.in" => __('Owner Gender must be Male, Female or Others.'),
