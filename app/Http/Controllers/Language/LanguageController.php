...
class LanguageController extends Controller
{
    ...
    $customNames = [
        ...
        'swm_organizations' => 'SW Organizations',
        'swm_work_types' => 'SW Service Provider Work Types',
        'swm_workers' => 'SW Service Provider Workers',
        'swm_vehicle_types' => 'SW Service Provider Vehicle Types',
        'swm_vehicles' => 'SW Service Provider Vehicles',
        'swm_landfills' => 'SW Service Facility Landfills',
        'swm_sts' => 'SW Service Facility STS',
        'swm_bill_collection_payments' => 'SW Bill Collection Payments',
        'swm_billing_status' => 'SW Billing Status',
        'swm_complaints' => 'SW Complaints',
        'swm_billing' => 'SW Billing',
