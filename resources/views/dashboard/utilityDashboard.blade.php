...
@can('Road Count Box')
    ...
    <h1 style="padding: 15px 0 15px 0;font-size: 24px;font-weight: bold;">{{ __('Road')}}</h1>
    <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-xs-12  extra-padding">
            <h1 style="padding: 15px 0 15px 0;font-size: 18px;font-weight: bold;">{{ __('Road Length by Surface Type (m)')}}</h1>
            <div class="row">
            ...
            <h1 style="padding: 15px 0 15px 0;font-size: 18px;font-weight: bold;">{{__('Road Length by Width (m)')}}</h1>
            <div class="row">
            ...
            <h1 style="padding: 15px 0 15px 0;font-size: 18px;font-weight: bold;">{{ __('Road Length by Hierarchy (m)')}} </h1>
            <div class="row">
...
@can('Drain Count Box')
<h1 style="padding: 15px 0 15px 0;font-size: 24px;font-weight: bold;">{{ __('Drain')}}</h1>
<div class="row">
    <div class="col-lg-3 col-md-12 col-xs-12  d-flex">
        @include('dashboard.countBox._sumDrainsCountBox')
    </div> <!-- main col div -->
    <div class="col-lg-9 col-md-12 col-xs-12  extra-padding">
        <h1 style="padding: 15px 0 15px 0;font-size: 18px;font-weight: bold;">{{ __('Drain Length by Diameter (m)')}} </h1>
        <div class="row">
            <div class="col-lg-3  d-flex">
        ...
        <h1 style="padding: 15px 0 15px 0;font-size: 18px;font-weight: bold;">{{ __('Drain Length by Type (m)')}}</h1>
        <div class="row">
            <div class="col-lg-4  d-flex">
        ...
        <h1 style="padding: 15px 0 15px 0;font-size: 18px;font-weight: bold;">{{ __('Drain Length by Surface Type (m)')}}</h1>
        <div class="row">
            <div class="col-lg-4  d-flex">
...
<h1 style="padding: 15px 0 15px 0;font-size: 24px;font-weight: bold;">{{ __('Water Supply')}}</h1>
<div class="row">
    <div class="col-lg-3 col-md-12 col-xs-12  d-flex">
        @include('dashboard.countBox._sumWatersupplyCountBox')
    </div> <!-- main col div -->
    <div class="col-lg-9 col-md-12 col-xs-12  extra-padding">
        <h1 style="padding: 15px 0 15px 0;font-size: 18px;font-weight: bold;">{{ __('Water Supply Length by Diameter (m)')}}</h1>
        <div class="row">
            <div class="col-lg-3  d-flex">
