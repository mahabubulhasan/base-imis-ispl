...
Developed By: Streams Tech Ltd.
Description: FSM Application Form - Vue 3 Implementation with Language Support -->
...
<div class="tab-content p-5 md:p-10 min-h-[calc(100vh-100px)] animate-fadeIn">
    <div class="bg-white p-5 md:p-8 rounded-xl shadow-lg border border-slate-200 w-full max-w-6xl mx-auto">
        <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold text-center text-slate-900 mb-6 md:mb-8">{{ __('fsm.form_title') }}</h1>
        ...
        <form @submit.prevent="handleSubmit" class="needs-validation" novalidate>
            ...
            <fieldset class="app_fieldset">
                <legend>{{ __('fsm.tax_section') }}</legend>

                <div class="row">
                    <div class="col-12 mb-3">
                        <label class="block text-gray-800 font-semibold mb-2 text-base">
                            {{ __('fsm.do_you_have_tax_code') }} <span class="text-red-500">*</span>
                        </label>
                        <select
                            v-model="hasTaxId"
                        ...
                        >
                            ...
                            <option value="yes">{{ __('fsm.yes') }}</option>
                            <option value="no">{{ __('fsm.no') }}</option>
                        </select>
                ...
                <div v-show="showTaxIdField" class="row">
                    <div class="col-12 col-md-6 mb-3">
                        <label class="block text-gray-800 font-semibold mb-2 text-base">
                            {{ __('fsm.tax_code') }} <span v-if="showTaxIdField" class="text-red-500">*</span>
                        </label>
                        <input
                            type="text"
                            v-model="taxId"
                            ...
                            placeholder="{{ __('fsm.tax_code_placeholder') }}"
                        >
            ...
            <fieldset class="app_fieldset">
                <legend>{{ __('fsm.applicant_section') }}</legend>

                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        <label class="block text-gray-800 font-semibold mb-2 text-base">
                            {{ __('fsm.applicant_name') }} <span class="text-red-500">*</span>
                        </label>
                        <input
                            type="text"
                            ...
                            placeholder="{{ __('fsm.applicant_name_placeholder') }}"
                        >
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <label class="block text-gray-800 font-semibold mb-2 text-base">
                            {{ __('fsm.contact_no') }} <span class="text-red-500">*</span>
                        </label>
                        <input
                            type="tel"
                            ...
                            placeholder="{{ __('fsm.contact_placeholder') }}"
                        >
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <input
                            ...
                            placeholder="{{ __('fsm.holding_owner_placeholder') }}"
                        >
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <label class="block text-gray-800 font-semibold mb-2 text-base">
                            {{ __('fsm.ward') }} <span class="text-red-500">*</span>
                        </label>
                        <select
                            v-model="ward"
                        ...
                        >
                            <option value="">{{ __('fsm.select_ward') }}</option>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <label class="block text-gray-800 font-semibold mb-2 text-base">
                            {{ __('fsm.address') }} <span class="text-red-500">*</span>
                        </label>
                        <textarea
                            v-model="address"
                            ...
                            rows="3"
                            placeholder="{{ __('fsm.address_placeholder') }}"
                        ></textarea>
            ...
            <fieldset class="app_fieldset">
                <legend>{{ __('fsm.service_section') }}</legend>

                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        <label class="block text-gray-800 font-semibold mb-2 text-base">
                            {{ __('fsm.proposed_emptying_date') }}<span class="text-red-500">*</span>
                        </label>
                        <input
                            type="date"
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea
                            ...
                            rows="3"
                            placeholder="{{ __('fsm.notes_placeholder') }}"
                        ></textarea>
...
<div v-if="showModal" class="fsm-modal-overlay">
    <div class="fsm-modal-content">
        ...
        <h3 class="text-2xl font-bold text-center text-gray-800 mb-3">{{ __('fsm.submission_success') }}</h3>
        <p class="text-center text-gray-600 mb-4">@{{ successMessage }}</p>
        <p class="text-center text-sm text-gray-500 mb-4">{{ __('fsm.redirect_message', ['seconds' => '']) }}<span>@{{ countdown }}</span> {{ __('common.loading') }}</p>
