...
<div id="contact" class="tab-content p-5 md:p-10 min-h-[calc(100vh-100px)] animate-fadeIn">
    <div class="max-w-6xl mx-auto bg-white p-6 md:p-10 rounded-xl shadow-lg border border-slate-200">
        <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold text-center text-slate-900 mb-6 md:mb-8">Contact Us</h1>
        <p class="text-slate-700 text-base md:text-lg leading-relaxed"><strong>Lakshmipur Paurashava</strong></p>
