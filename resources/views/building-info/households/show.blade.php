...
<div class="card card-info">
    ...
    <div class="form-horizontal">
        <div class="card-body">
            ...
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('Tax Code') }}</label><div class="col-sm-3">{!! Form::label(null, $household->tax_id, ['class' => 'form-control']) !!}</div></div>
            ...
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('No. of Family Members') }}</label><div class="col-sm-3">{!! Form::label(null, $household->number_of_family_members, ['class' => 'form-control']) !!}</div></div>
