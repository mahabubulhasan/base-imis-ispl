...
<body>
    <div class="container">
        ...
        <table class="table" width="100%" style="margin-top: 20px; border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: right; font-size: 18px; margin: 0; border: none;">{{ __('Year') }}: {{$year}}
                </td>
            </tr>
        </table>
    ...
    <table class="table" width="100%" style="margin-top: 20px; border-collapse: collapse;">
        ...
        <tr>
            <td style="font-size : 18px; ">{{ __('Total Revenue (BDT)') }} </td>
    ...
    <!-- end for each -->
    <div style="margin-top: 30px; letter-spacing: 0.2px; padding: 2px; background-color: #ddddde;">
        <span style="font-size: 19px; font-weight: bold;">{{ __('Cumulative Data for')}} {{$year}} {{ __('upto')}}
            {{$monthName}}
        </span>
    </div>
    ...
    <table class="table table-bordered table-striped" width="100%"
        style="margin-top: 20px; letter-spacing: 0.2px; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td style="letter-spacing: 0.2px;"> {{ __('Total Revenue (BDT)') }} </td>
        </tr>
