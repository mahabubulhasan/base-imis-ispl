<section class="section">
    <div class="section-header"><h2>(৫) উন্নয়ন প্রস্তাবনা</h2></div>
    <div class="section-body">
        <div class="field">
            <label><span class="num">৫</span><span class="text">কঠিন বর্জ্য ব্যবস্থাপনার উন্নতি সাধনে কোনো প্রস্তাব থাকিলে উহা বিবৃত করুন</span></label>
...
<section class="section">
    <div class="section-header"><h2>(৬) বেসরকারি প্রক্রিয়াকরণ চুক্তির বিবরণ</h2></div>
    <div class="section-body">
        <div class="tbl-wrap">
...
<section class="section">
    <div class="section-header"><h2>(৭) স্বাস্থ্যসম্মত উপায়ে সম্পাদনের পদক্ষেপ</h2></div>
    <div class="section-body">
        <div class="grid cols-1">
            @foreach([
                ['step_dairy', '৭ (অ)', 'দুগ্ধ খামার'],
                ['step_slaughter', '৭ (আ)', 'পশু জবেহ'],
                ['step_construction', '৭ (ই)', 'নির্মাণ-ভাঙন বর্জ্য'],
                ['step_encroachment', '৭ (ঈ)', 'পার্ক, হাঁটার পথ, ইত্যাদি জবর দখল'],
            ] as [$name, $num, $label])
            <div class="field">
...
<section class="section">
    <div class="section-header"><h2>(৯) মোবাইল কোর্ট পরিচালনা</h2></div>
    <div class="section-body">
        <div class="tbl-wrap">
            <table class="tbl">
                <thead>
...
<section class="section">
    ...
    <div class="section-body">
        <div class="grid">
            <div class="field">
                <label><span class="num">১০ (অ)</span><span class="text">সরকারি হাসপাতাল বা ক্লিনিক বা স্বাস্থ্য কেন্দ্র সংখ্যা</span></label>
                <input name="gov_hospitals" type="number" min="0" />
            </div>
            <div class="field">
                <label><span class="num">১০ (আ)</span><span class="text">সিটি কর্পোরেশন বা পৌরসভার হাসপাতাল বা ক্লিনিক সংখ্যা</span></label>
                <input name="city_hospitals" type="number" min="0" />
            </div>
            <div class="field doe-field-full-row">
                <label><span class="num">১০ (ই)</span><span class="text">বেসরকারি হাসপাতাল বা ক্লিনিক সংখ্যা</span></label>
                <input name="private_hospitals" type="number" min="0" />
            </div>
            <div class="field doe-field-full-row">
                <label><span class="num">১০ (ঈ)</span><span class="text">সকল হাসপাতাল বা ক্লিনিক ও স্বাস্থ্য কেন্দ্রের ক্ষেত্রে চিকিৎসা বর্জ্য (ব্যবস্থাপনা ও প্রক্রিয়াজাতকরণ) বিধিমালা, ২০০৮ এর বিধানাবলি যথাযথভাবে অনুসরণ করা হয় কিনা</span></label>
            ...
            <div class="field doe-field-full-row">
                <label><span class="num">১০ (উ)</span><span class="text">চিকিৎসা বর্জ্য (ব্যবস্থাপনা ও প্রক্রিয়াজাতকরণ) বিধিমালা, ২০০৮ এর বিধানাবলি অনুসরণ করতে কোনো অসুবিধা হয়ে থাকলে তার বিবরণ</span></label>
