<section class="section">
    <div class="section-header"><h2>(২) দৈনিক সৃজিত গড় কঠিন বর্জ্যের পরিমাণ</h2></div>
    <div class="section-body">
        <div class="subsection">
            <div class="grid">
                <div class="field">
                    <label><span class="num">২.০</span><span class="text">দৈনিক সৃজিত গড় কঠিন বর্জ্যের পরিমাণ</span>@include('swm.dashboard.compliance-report.partials.auto-tip')</label>
                ...
                <div class="field">
                    <label><span class="num">২.১</span><span class="text">বাৎসরিক কঠিন বর্জ্যের পরিমাণ</span>@include('swm.dashboard.compliance-report.partials.auto-tip')</label>
                ...
                <div class="field">
                    <label><span class="num">২.২</span><span class="text">বিধিবদ্ধ পদ্ধতিতে সংগৃহীত বাৎসরিক কঠিন বর্জ্যের পরিমাণ</span>@include('swm.dashboard.compliance-report.partials.auto-tip')</label>
                ...
                <div class="field">
                    <label><span class="num">২.৩</span><span class="text">অনুমোদিত স্থানে স্তুপীকৃত কঠিন বর্জ্যের পরিমাণ (বাৎসরিক)</span>@include('swm.dashboard.compliance-report.partials.auto-tip')</label>
                ...
                <div class="field">
                    <label><span class="num">২.৪</span><span class="text">অসংগৃহীত কঠিন বর্জ্যের পরিমাণ (বাৎসরিক)</span>@include('swm.dashboard.compliance-report.partials.auto-tip')</label>
                ...
                <div class="field">
                    <label><span class="num">২.৫</span><span class="text">ঝুঁকিপূর্ণ শিল্প বর্জ্য সংগ্রহের পরিমাণ (বাৎসরিক)</span></label>
                    <div class="unit-suffix"><input name="hazardous" type="number" min="0" step="0.01"/><span class="u">টন</span></div>
                </div>
            </div>
        </div>
        <div class="subsection">
            <h3 class="subsection-title">২.৬ বাৎসরিক বর্জ্য প্রক্রিয়াকরণের পরিমাণ (সরকারি/বেসরকারি উদ্যোগে)</h3>
            <div class="grid">
                @foreach([
