...
<div class="card card-info">
    ...
    <div class="app-mobile-form">
        <div class="card-body">
            ...
            <div class="form-group row">
                <span class="col-sm-3 control-label">{{ __('Waste Processing Site Name') }}</span>
                <div class="col-sm-9"><p class="form-control-plaintext mb-0">{{ $wasteProcessingLog->waste_processing_site_name ?: '—' }}</p></div>
            </div>
            <div class="form-group row">
