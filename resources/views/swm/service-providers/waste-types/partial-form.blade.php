<div class="swm-waste-type-form-mobile app-mobile-form">
<div class="card-body">
        <div class="form-group row required">
            {!! Form::label('name', __('Waste Type'), ['class' => 'col-sm-3 control-label']) !!}
            <div class="col-sm-3">
                {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Waste Type Name')]) !!}
            </div>
        </div>
