...
<div class="card card-info">
    ...
    <div class="form-horizontal swm-primary-collection-site-form-mobile app-mobile-form">
        <div class="card-body">
            ...
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('Contact No.') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->contact_number, ['class' => 'form-control']) !!}</div></div>
            ...
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('Holding No.') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->holding_number, ['class' => 'form-control']) !!}</div></div>
