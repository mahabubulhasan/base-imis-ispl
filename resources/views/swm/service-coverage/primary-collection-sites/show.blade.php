...
<div class="card card-info">
    ...
    <div class="form-horizontal">
        <div class="card-body">
            ...
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('Road No./Name') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->road_no_name, ['class' => 'form-control']) !!}</div></div>
            ...
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('Owner (Y/N)') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->is_owner ? __('Yes') : __('No'), ['class' => 'form-control']) !!}</div></div>
            ...
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('LIC (Y/N)') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->is_lic ? __('Yes') : __('No'), ['class' => 'form-control']) !!}</div></div>
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('LIC ID') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->lic_id, ['class' => 'form-control']) !!}</div></div>
            ...
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('Segregation Practiced (Y/N)') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->segregation_practiced ? __('Yes') : __('No'), ['class' => 'form-control']) !!}</div></div>
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('Waste bin Provided (Y/N)') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->waste_bin_provided ? __('Yes') : __('No'), ['class' => 'form-control']) !!}</div></div>
            ...
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('Van Puller ID') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->van_puller_id, ['class' => 'form-control']) !!}</div></div>
            <div class="form-group row"><label class="col-sm-3 control-label">{{ __('Van Puller Name') }}</label><div class="col-sm-3">{!! Form::label(null, $primaryCollectionSite->van_puller_name, ['class' => 'form-control']) !!}</div></div>
        </div>
    </div>
</div>
@stop
